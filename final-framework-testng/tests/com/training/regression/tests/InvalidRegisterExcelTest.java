...
public class InvalidRegisterExcelTest {
	...
	public void InvalidRegisterExcel(String firstName,String lastName,String Email,String Telephone,String Address1, String Address2, String City, String postalCode, String Country, String Region, String password, String passwordConfirm) throws InterruptedException {
...
//		String ExpectedMsgText="If you already have an account with us, please login at the login page.";
//		String ActualMsgText= registerPOM.errormsgtext();
